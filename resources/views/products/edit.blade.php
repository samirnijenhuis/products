                ...
                <div class="box-body">
                    <form action="{{ route('products.update', $product->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="description" name="description" placeholder="Description" value="{{ old('description', $product->description) }}">
                        </div>
                            ...
                            <select name="type_id" id="type_id">
                                @foreach($types as $type)
                                    <option value="{{ $type->id }}"
                                            @if($product->type->id == $type->id) selected @endif>
                                                {{ $type->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="stock_id" id="stock_id">
                                @foreach($stock as $stock_option)
                                    <option value="{{ $stock_option->id }}"
                                            @if($product->stock->id == $stock_option->id) selected @endif>
                                                {{ $stock_option->option }}
                                    </option>
                                @endforeach
                            </select>
